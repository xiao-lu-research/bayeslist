...
#' }
#'
#' @references Traunmüller, R., Kijewski, S., & Freitag, M. (2019). The silent victims of sexual violence during war: Evidence from a list experiment in Sri Lanka. Journal of conflict resolution, 63(9), 2015-2042. \url{https://doi.org/10.1177/0022002719828053}
#' @keywords datasets
NULL
...
#' @source The full data set is available at \url{https://doi.org/10.7910/DVN/W90Q7B})
#' @keywords datasets
NULL
