...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_outcome_cmp");
    reader.add_event(72, 70, "end", "model_model_outcome_cmp");
    return reader;
}
...
class model_model_outcome_cmp : public prob_grad {
private:
    int N;
    int J;
    vector<int> Y;
...
typedef model_model_outcome_cmp_namespace::model_model_outcome_cmp stan_model;
#endif
