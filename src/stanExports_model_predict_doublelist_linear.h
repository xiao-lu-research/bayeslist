...
public:
  ...
  inline std::string model_name() const final { return "model_model_predict_doublelist_linear"; }
  ...
  model_model_predict_doublelist_linear(stan::io::var_context& context__,
    ...
    try {
      ...
      context__.validate_dims("data initialization","mu_psi2","double",
          context__.to_vec(K));
      mu_psi2 = std::vector<double>(K, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 51;
      assign(mu_psi2, nil_index_list(), context__.vals_r("mu_psi2"),
        "assigning variable mu_psi2");
      current_statement__ = 52;
      validate_non_negative_index("sigma_psi2", "K", K);
      current_statement__ = 53;
      context__.validate_dims("data initialization","sigma_psi2","double",
          context__.to_vec(K));
      sigma_psi2 = std::vector<double>(K, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 53;
      assign(sigma_psi2, nil_index_list(), context__.vals_r("sigma_psi2"),
        "assigning variable sigma_psi2");
      current_statement__ = 53;
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        current_statement__ = 53;
        current_statement__ = 53;
        check_greater_or_equal(function__, "sigma_psi2[sym1__]",
                               sigma_psi2[(sym1__ - 1)], 0);}
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_model_predict_doublelist_linear_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      }
      {
        ...
        for (int i = 1; i <= K; ++i) {
          ...
          lp_accum__.add(
            normal_lpdf<propto__>(psi2[(i - 1)], mu_psi2[(i - 1)],
              sigma_psi2[(i - 1)]));}
        ...
        lp_accum__.add(normal_lpdf<propto__>(gamma0, mu_gamma0, sigma_gamma0));
