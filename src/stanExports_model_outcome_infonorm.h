...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_outcome_infonorm");
    reader.add_event(69, 67, "end", "model_model_outcome_infonorm");
    return reader;
}
...
class model_model_outcome_infonorm : public prob_grad {
private:
    int N;
    int J;
    vector<int> Y;
...
typedef model_model_outcome_infonorm_namespace::model_model_outcome_infonorm stan_model;
#endif
