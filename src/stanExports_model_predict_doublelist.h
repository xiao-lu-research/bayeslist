...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_predict_doublelist");
    reader.add_event(91, 89, "end", "model_model_predict_doublelist");
    return reader;
}
...
class model_model_predict_doublelist : public prob_grad {
private:
    int N;
    int J;
    vector<int> Y;
...
typedef model_model_predict_doublelist_namespace::model_model_predict_doublelist stan_model;
#endif
