...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_predict_noaux");
    reader.add_event(81, 79, "end", "model_model_predict_noaux");
    return reader;
}
...
class model_model_predict_noaux : public prob_grad {
private:
    int N;
    int J;
    vector<int> Y;
...
typedef model_model_predict_noaux_namespace::model_model_predict_noaux stan_model;
#endif
