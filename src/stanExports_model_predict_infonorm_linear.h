...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_predict_infonorm_linear");
    reader.add_event(82, 80, "end", "model_model_predict_infonorm_linear");
    return reader;
}
...
class model_model_predict_infonorm_linear : public prob_grad {
private:
    int N;
    int J;
    vector<int> Y;
...
typedef model_model_predict_infonorm_linear_namespace::model_model_predict_infonorm_linear stan_model;
#endif
