...
public:
  ...
  inline std::string model_name() const final { return "model_model_misreport_noaux"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_model_misreport_noaux_namespace::log_prob";
(void) function__;  // suppress unused var warning
