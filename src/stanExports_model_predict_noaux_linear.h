...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_predict_noaux_linear");
    reader.add_event(80, 78, "end", "model_model_predict_noaux_linear");
    return reader;
}
...
class model_model_predict_noaux_linear : public prob_grad {
private:
    int N;
    int J;
    vector<int> Y;
...
public:
    ...
    static std::string model_name() {
        return "model_model_predict_noaux_linear";
    }
...
typedef model_model_predict_noaux_linear_namespace::model_model_predict_noaux_linear stan_model;
#endif
