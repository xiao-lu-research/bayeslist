...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_outcome_aux");
    reader.add_event(100, 98, "end", "model_model_outcome_aux");
    return reader;
}
...
class model_model_outcome_aux : public prob_grad {
private:
    int N;
    int J;
    vector<int> Y;
...
typedef model_model_outcome_aux_namespace::model_model_outcome_aux stan_model;
#endif
