...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_outcome_noaux");
    reader.add_event(65, 63, "end", "model_model_outcome_noaux");
    return reader;
}
...
class model_model_outcome_noaux : public prob_grad {
private:
    int N;
    int J;
    vector<int> Y;
...
typedef model_model_outcome_noaux_namespace::model_model_outcome_noaux stan_model;
#endif
