...
public:
  ...
  model_model_misreport_doublelist(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_model_misreport_doublelist_namespace::model_model_misreport_doublelist";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    try {
      ...
      stan::math::validate_non_negative_index("mu_gamma0", "K", K);
      current_statement__ = 60;
      context__.validate_dims("data initialization", "mu_gamma0", "double",
        std::vector<size_t>{static_cast<size_t>(K)});
      mu_gamma0 = std::vector<double>(K,
                    std::numeric_limits<double>::quiet_NaN());
      current_statement__ = 60;
      mu_gamma0 = context__.vals_r("mu_gamma0");
      current_statement__ = 61;
      stan::math::validate_non_negative_index("sigma_gamma0", "K", K);
      current_statement__ = 62;
      context__.validate_dims("data initialization", "sigma_gamma0",
        "double", std::vector<size_t>{static_cast<size_t>(K)});
      sigma_gamma0 = std::vector<double>(K,
                       std::numeric_limits<double>::quiet_NaN());
      current_statement__ = 62;
      sigma_gamma0 = context__.vals_r("sigma_gamma0");
      current_statement__ = 62;
      ...
      context__.validate_dims("data initialization", "sigma_treate",
        "double", std::vector<size_t>{});
      sigma_treate = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 64;
      sigma_treate = context__.vals_r("sigma_treate")[(1 - 1)];
      current_statement__ = 64;
      stan::math::check_greater_or_equal(function__, "sigma_treate",
        sigma_treate, 0);
      ...
      current_statement__ = 66;
      stan::math::check_greater_or_equal(function__, "sigma_ue", sigma_ue, 0);
      ...
      current_statement__ = 68;
      stan::math::check_greater_or_equal(function__, "sigma_ze", sigma_ze, 0);
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_model_misreport_doublelist_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
               ...
               jacobian__>(0, 1, lp__);
      {
        ...
        for (int i = 1; i <= K; ++i) {
          ...
          lp_accum__.add(stan::math::normal_lpdf<propto__>(
                           stan::model::rvalue(gamma0, "gamma0",
                             stan::model::index_uni(i)),
                           stan::model::rvalue(mu_gamma0, "mu_gamma0",
                             stan::model::index_uni(i)),
                           stan::model::rvalue(sigma_gamma0, "sigma_gamma0",
                             stan::model::index_uni(i))));
        ...
        lp_accum__.add(stan::math::normal_lpdf<propto__>(treat_e, mu_treate,
                         sigma_treate));
        current_statement__ = 15;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(U_e, mu_ue, sigma_ue));
        current_statement__ = 16;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(Z_e, mu_ze, sigma_ze));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_model_misreport_doublelist_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
